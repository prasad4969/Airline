...
const { searchFlight, bookFlight, getBookedFlights, getUserDetails, updateUserDetails,alreadybooked, searchAllFlights, insertFlight } = require('../controllers/appController');
...
/* POST Methods */
router.route('/flight').post(insertFlight)
